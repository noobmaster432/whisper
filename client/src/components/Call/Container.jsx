...
function Container({ data }) {
  ...
  return (
    <div className="border-conversation-border border-l w-full bg-conversation-panel-background flex flex-col h-screen overflow-hidden items-center justify-center text-white">
      ...
      <div className="h-14 w-14 bg-red-600 flex items-center justify-center rounded-full">
        <MdOutlineCallEnd
